...
internal static class ChineseLocalization
{
    ...
    private static readonly IReadOnlyDictionary<string, string> Text = new Dictionary<string, string>(StringComparer.Ordinal)
    {
        ...
        ["Cosmetic replacements are organized by hero. Expand a hero, then choose Skins or Weapon Models."] = "外观替换按英雄分类。展开英雄，然后选择皮肤或武器模型。",
        ["Skins"] = "皮肤",
        ["Weapon Models"] = "武器模型",
        ["No custom skins available yet."] = "暂无自定义皮肤。",
        ["No custom weapon models available yet."] = "暂无自定义武器模型。",
        ["Imported No-Hammers Rifle"] = "导入的无击锤步枪",
        ["Ninja Turtle Skin"] = "忍者龟皮肤",
        ["Turtle"] = "忍者龟",
        ["Replaces Ninja's default third-person body, first-person arms, and katana textures with the Turtle texture set. Geometry, animations, and hitboxes remain unchanged. Requires rebuild."] = "使用忍者龟纹理集替换忍者默认的第三人称身体、第一人称手臂和武士刀纹理。几何体、动画和碰撞箱保持不变。需要重新构建。",
        ["Vander Blue Skin"] = "范德蓝色皮肤",
        ["Blue"] = "蓝色",
        ["Replaces Vander's default third-person body and first-person arms with the Blue texture set. Geometry, animations, weapons, and hitboxes remain unchanged. Requires rebuild."] = "使用蓝色纹理集替换范德默认的第三人称身体和第一人称手臂。几何体、动画、武器和碰撞箱保持不变。需要重新构建。",
        ["Anthony 'Tony' Turretto"] = "安东尼“托尼”图雷托",
        ["Hindu Yeti Skin"] = "印度雪怪皮肤",
        ["Hindu Yeti"] = "印度雪怪",
        ["Yeti"] = "雪怪",
        ["Replaces Yeti's S1 body, first-person arms, snow weapons, and ice effects with the Hindu Yeti texture set. Other Yeti skins, geometry, animations, and hitboxes remain unchanged. Requires rebuild."] = "使用印度雪怪纹理集替换雪怪 S1 的身体、第一人称手臂、冰雪武器和冰冻特效。其他雪怪皮肤、几何体、动画和碰撞箱保持不变。需要重新构建。",
        ["Darklord SS"] = "黑暗领主 SS",
        ["Darklord SS Skin"] = "黑暗领主 SS 皮肤",
        ["Replaces the Devil SS body and first-person arms, including Blitz and Graviton states, with the Darklord SS texture set. Other Sweet Science skins, geometry, animations, and hitboxes remain unchanged. Requires rebuild."] = "使用黑暗领主 SS 纹理集替换恶魔 SS 的身体和第一人称手臂，包括闪击和引力状态。甜蜜科学的其他皮肤、几何体、动画和碰撞箱保持不变。需要重新构建。",
