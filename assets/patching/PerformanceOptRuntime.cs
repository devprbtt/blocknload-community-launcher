...
namespace BnlCommunityFixes
{
    public static class PerformanceOptRuntime
    {
        ...
        public static bool ShouldDisableMinimapObjectPopulation()
        {
            return string.Equals(PerformanceOptGeneratedConfig.DiagnosticMode, "__CPU_DISABLE_MINIMAP_OBJECT_POP__", System.StringComparison.OrdinalIgnoreCase);
        }

        public static bool ShouldDisableZoneNotifications()
        {
            return string.Equals(PerformanceOptGeneratedConfig.DiagnosticMode, "__CPU_DISABLE_ZONE_NOTIFICATIONS__", System.StringComparison.OrdinalIgnoreCase);
        }

        public static bool ShouldDisableSupplyTimer()
        {
            return string.Equals(PerformanceOptGeneratedConfig.DiagnosticMode, "__CPU_DISABLE_SUPPLY_TIMER__", System.StringComparison.OrdinalIgnoreCase);
        }

        public static bool ShouldDisableZoneMusic()
        {
            return string.Equals(PerformanceOptGeneratedConfig.DiagnosticMode, "__CPU_DISABLE_ZONE_MUSIC__", System.StringComparison.OrdinalIgnoreCase);
        }

        public static bool ShouldDisableFactoryColors()
        {
            return string.Equals(PerformanceOptGeneratedConfig.DiagnosticMode, "__CPU_DISABLE_FACTORY_COLORS__", System.StringComparison.OrdinalIgnoreCase);
        }

        public static bool ShouldDisableGravityTrapEffects()
        {
            string m = PerformanceOptGeneratedConfig.DiagnosticMode;
            return string.Equals(m, "__CPU_DISABLE_GRAVITY_TRAP_EFFECTS__", System.StringComparison.OrdinalIgnoreCase)
                || string.Equals(m, "__CPU_DISABLE_DEVICE_EFFECTS_COMBINED__", System.StringComparison.OrdinalIgnoreCase);
        }

        public static bool ShouldDisableForcefieldShieldEffects()
        {
            string m = PerformanceOptGeneratedConfig.DiagnosticMode;
            return string.Equals(m, "__CPU_DISABLE_FORCEFIELD_SHIELD_EFFECTS__", System.StringComparison.OrdinalIgnoreCase);
        }

        public static bool ShouldDisableFanAnimators()
        {
            string m = PerformanceOptGeneratedConfig.DiagnosticMode;
            return string.Equals(m, "__CPU_DISABLE_FAN_ANIMATORS__", System.StringComparison.OrdinalIgnoreCase)
                || string.Equals(m, "__CPU_DISABLE_DEVICE_EFFECTS_COMBINED__", System.StringComparison.OrdinalIgnoreCase);
        }

        public static bool ShouldDisableTeslaLogic()
        {
            return string.Equals(PerformanceOptGeneratedConfig.DiagnosticMode, "__CPU_DISABLE_TESLA_LOGIC__", System.StringComparison.OrdinalIgnoreCase);
        }

        public static bool ShouldDisableMinimapRoot()
        {
            return string.Equals(PerformanceOptGeneratedConfig.DiagnosticMode, "__CPU_DISABLE_MINIMAP_ROOT__", System.StringComparison.OrdinalIgnoreCase);
        }

        public static bool ShouldDisablePortalUpdate()
        {
            return string.Equals(PerformanceOptGeneratedConfig.DiagnosticMode, "__CPU_DISABLE_PORTAL_UPDATE__", System.StringComparison.OrdinalIgnoreCase);
        }

        public static bool ShouldDisableTurretModelAnimations()
        {
            return string.Equals(PerformanceOptGeneratedConfig.DiagnosticMode, "__CPU_DISABLE_TURRET_MODEL_ANIMATIONS__", System.StringComparison.OrdinalIgnoreCase);
        }

        public static bool ShouldDisableMortarModelAnimations()
        {
            return string.Equals(PerformanceOptGeneratedConfig.DiagnosticMode, "__CPU_DISABLE_MORTAR_MODEL_ANIMATIONS__", System.StringComparison.OrdinalIgnoreCase);
        }

        public static bool ShouldDisableWsiFactory()
        {
            return string.Equals(PerformanceOptGeneratedConfig.DiagnosticMode, "__CPU_DISABLE_WSI_FACTORY__", System.StringComparison.OrdinalIgnoreCase);
        }
